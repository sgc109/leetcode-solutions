<h2><a href="https://leetcode.com/problems/group-shifted-strings/?envType=problem-list-v2&envId=2au01hlt">249. Group Shifted Strings</a></h2><h3>Medium</h3><hr><p>Perform the following shift operations on a string:</p>
