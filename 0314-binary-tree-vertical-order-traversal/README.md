<h2><a href="https://leetcode.com/problems/binary-tree-vertical-order-traversal/?envType=problem-list-v2&envId=2au01hlt">314. Binary Tree Vertical Order Traversal</a></h2><h3>Medium</h3><hr><p>Given the <code>root</code> of a binary tree, return <em><strong>the vertical order traversal</strong> of its nodes&#39; values</em>. (i.e., from top to bottom, column by column).</p>
