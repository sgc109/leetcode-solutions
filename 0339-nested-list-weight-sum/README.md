<h2><a href="https://leetcode.com/problems/nested-list-weight-sum/?envType=problem-list-v2&envId=2au01hlt">339. Nested List Weight Sum</a></h2><h3>Medium</h3><hr><p>You are given a nested list of integers <code>nestedList</code>. Each element is either an integer or a list whose elements may also be integers or other lists.</p>
