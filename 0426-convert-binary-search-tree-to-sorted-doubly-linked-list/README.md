<h2><a href="https://leetcode.com/problems/convert-binary-search-tree-to-sorted-doubly-linked-list/?envType=problem-list-v2&envId=2au01hlt">426. Convert Binary Search Tree to Sorted Doubly Linked List</a></h2><h3>Medium</h3><hr><p>Convert a <strong>Binary Search Tree</strong> to a sorted <strong>Circular Doubly-Linked List</strong> in place.</p>
