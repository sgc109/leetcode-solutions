<h2><a href="https://leetcode.com/problems/minesweeper/?envType=problem-list-v2&envId=2w1jhwl5">529. Minesweeper</a></h2><h3>Medium</h3><hr><p>Let&#39;s play the minesweeper game (<a href="https://en.wikipedia.org/wiki/Minesweeper_(video_game)" target="_blank">Wikipedia</a>, <a href="http://minesweeperonline.com" target="_blank">online game</a>)!</p>
